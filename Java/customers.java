...
pout.println("<body bgcolor=DA70D6><table border=1 width=1080 align=center>");
pout.println("<tr bgcolor=F49551 align=center><td>NO</td><td>customerid</td><td>companyname</td><td>contactname</td><td>contacttitle</td><td>address</td></tr>");
while ((b =  bin.readLine()) != null) {
fields = b.split(patternStr);
if(i%2 == 0)
pout.println("<tr bgcolor=FFE641>");
else
pout.println("<tr bgcolor=FFCAD5>");
